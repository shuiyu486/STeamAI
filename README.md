...
| `.rekit/facts/*.jsonl` | append-only ledger：observation、hypothesis、candidate、verification、decision、intervention、rollback、publication、request；Go runtime 通过 shared facts path/append helper 写入，避免各命令自行拼路径或追加 JSONL。 |
