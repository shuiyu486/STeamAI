...
/rekit status -Format text    # 显式 status text；显示 packSource、kit/case status、manifest、shim readiness、authorized-gate execution report contract handoff、latest-batch validation/remote handoff 与 bounded repair/status next-step handoff
