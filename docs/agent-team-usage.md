...
# 日常主Agent不必跨对象重建reviewer lifecycle：currentLoopOperator.selectedDriverRequest已选择fresh start或strict resume；externalReviewerHandoff.attempt绑定identity/SHA/receipt并只给当前selectedAction与durable continuation
