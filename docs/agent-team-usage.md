...
/rekit run-current-loop -Target <caseRoot> -MaxSteps 10 -WhatIf -Format json # 预览固定initial route/lane、exact首步与bounded loop policy，返回expectedCurrentLoopPlanSha256
