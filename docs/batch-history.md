...
状态：已完成 promote candidates main-agent execution plan text consumption closure、本地实现、focused promote candidates CLI validation、durable docs 与 full local validation；commit/push 与远程 release-gate inspection 待执行。
