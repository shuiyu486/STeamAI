...
状态：已完成 runtime/CLI/test/docs implementation、focused/package validation 与完整本地 release minimum；正在执行 commit/push 与远程 release-gate inspection。
