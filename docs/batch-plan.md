...
状态：已完成 runtime/CLI/test/docs implementation、focused/package validation 与完整本地 release minimum；待 implementation commit/push；远程 release-gate inspection 待完成。
