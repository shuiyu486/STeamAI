...
状态：已完成 CLI product-path 测试实现、focused/related repair tests、release-handoff parser regression、完整本机 `release-run` release minimum 与文档记录；最终本机 release-run 7/7 通过。implementation commit 尚待提交/push，随后检查 push-triggered remote release-gate。
