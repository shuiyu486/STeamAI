...
状态：已完成 release handoff / status project current-action runtime、CLI/releasecheck regression、真实 `status` smoke 与完整本机 `release-run` release minimum；implementation commit/push 与 push-triggered remote release-gate inspection 待执行。
