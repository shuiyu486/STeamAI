...
状态：已完成 pack-memory candidate identity runtime projection、release/status text handoff、focused release/status 与 case-local product-path coverage、durable docs 与本机 release minimum；commit/push 与远程 release-gate inspection 待完成。
