...
- runtime 不含领域业务逻辑；default pack 决策点已在 Batch 150 收口到 Go `defaults.DefaultPack`，Batch 151/152/153/154/155/156/157 已取消 Go manifest 的 deny baseline、promoteFiles、defaultMarkdown、laneTypes title/workspaceRoot、managedBlock、identity 与 description fallback/缺省有效状态，gate action、default risk、默认 stop conditions、promote deny baseline、回流文件范围、默认文档预算、工作线 workspace/display 边界、managed block 三要素、pack identity 与用途摘要来自 pack manifest，而不是 Go runtime 硬编码。
