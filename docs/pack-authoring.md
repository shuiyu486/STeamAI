...
本仓库提供 `packs/_template/` 作为新 pack 的起点；已落地的 `packs/web-security/`、`packs/malware-analysis/`、`packs/vuln-research/`、`packs/ctf/`、`packs/unpack-pe/` 与 `packs/ollvm/` 可作为安全领域 skeleton 参考。创建真实 pack 时复制该目录并替换：
