...
- `./rekit/rekit.ps1 -Command doctor` 与 `./rekit/tests/facade-smoke.ps1` 不属于默认 release gate；只有改迁移期 façade、fallback 或 Windows compatibility 时按需追加。
