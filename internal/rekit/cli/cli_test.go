...
func assertReleaseCheckGoNativePublicSurface(t *testing.T, surface struct {
	...
	if len(surface.CommandProfileBoundaries) != 7 || surface.CommandProfileBoundaries[0].Boundary != commands.BoundaryCaseLocalAppend || surface.CommandProfileBoundaries[0].Count != 1 || strings.Join(surface.CommandProfileBoundaries[1].Commands, ",") != "attach,bootstrap,continue,gate,handoff,init,repair,start" || surface.CommandProfileBoundaries[len(surface.CommandProfileBoundaries)-1].Boundary != commands.BoundaryReadOnly || surface.CommandProfileBoundaries[len(surface.CommandProfileBoundaries)-1].Count != 5 {
		t.Fatalf("Go-native public command profile boundary rows drifted: %+v", surface.CommandProfileBoundaries)
	}
	if len(surface.CommandProfilePolicies) != 5 || commands.PublicProfilePolicyViolationCount(surface.CommandProfilePolicies) != 0 || surface.CommandProfilePolicies[0].Policy != commands.PublicProfilePolicyNoHeavyTool || !surface.CommandProfilePolicies[0].Ready || surface.CommandProfilePolicies[3].Policy != commands.PublicProfilePolicyReviewFirstApplyRequired || len(surface.CommandProfilePolicies[3].Commands) != 0 {
...
func assertReleaseCheckPublicFacadeRemoval(t *testing.T, inventory releasecheck.PublicFacadeRemoval) {
	...
	if !inventory.RemovalPlan.Ready || inventory.RemovalPlan.Document != "docs/powershell-deprecation.md" || len(inventory.RemovalPlan.RequiredPhrases) != 9 || len(inventory.RemovalPlan.ReplacementEntrypoints) != 4 || releaseCheckPublicFacadeRemovalReplacementValidationCommandCount(inventory.RemovalPlan.ReplacementEntrypoints) != 32 || len(inventory.RemovalPlan.DeletionGates) != 5 || releaseCheckPublicFacadeRemovalDeletionGateValidationCommandCount(inventory.RemovalPlan.DeletionGates) != 40 || releaseCheckPublicFacadeRemovalDeletionGateExitCriteriaCount(inventory.RemovalPlan.DeletionGates) != 15 || releaseCheckPublicFacadeRemovalDeletionGateFailureSignalCount(inventory.RemovalPlan.DeletionGates) != 15 || releaseCheckPublicFacadeRemovalDeletionGateEscalationTriggerCount(inventory.RemovalPlan.DeletionGates) != 15 || releaseCheckPublicFacadeRemovalDeletionGateEscalationEvidenceCount(inventory.RemovalPlan.DeletionGates) != 15 || releaseCheckPublicFacadeRemovalDeletionGateEscalationRecipientCount(inventory.RemovalPlan.DeletionGates) != 15 || releaseCheckPublicFacadeRemovalDeletionGateEscalationHandoffStepCount(inventory.RemovalPlan.DeletionGates) != 15 || releaseCheckPublicFacadeRemovalDeletionGateEscalationDecisionOptionCount(inventory.RemovalPlan.DeletionGates) != 15 || releaseCheckPublicFacadeRemovalDeletionGateEscalationRetryConditionCount(inventory.RemovalPlan.DeletionGates) != 15 || releaseCheckPublicFacadeRemovalDeletionGateEscalationStopConditionCount(inventory.RemovalPlan.DeletionGates) != 15 || releaseCheckPublicFacadeRemovalDeletionGateEscalationResolutionArtifactCount(inventory.RemovalPlan.DeletionGates) != 15 || releaseCheckPublicFacadeRemovalDeletionGateEscalationClosureCheckCount(inventory.RemovalPlan.DeletionGates) != 15 || releaseCheckPublicFacadeRemovalDeletionGateEscalationReopenConditionCount(inventory.RemovalPlan.DeletionGates) != 15 || releaseCheckPublicFacadeRemovalDeletionGateEscalationLedgerEventCount(inventory.RemovalPlan.DeletionGates) != 15 || releaseCheckPublicFacadeRemovalDeletionGateEscalationStateTransitionCount(inventory.RemovalPlan.DeletionGates) != 15 || releaseCheckPublicFacadeRemovalDeletionGateEscalationBoundaryGuardCount(inventory.RemovalPlan.DeletionGates) != 15 || releaseCheckPublicFacadeRemovalDeletionGateEscalationAuditCheckCount(inventory.RemovalPlan.DeletionGates) != 15 || releaseCheckPublicFacadeRemovalDeletionGateVerificationArtifactCount(inventory.RemovalPlan.DeletionGates) != 15 || releaseCheckPublicFacadeRemovalDeletionGateBlockedExecutionStepCount(inventory.RemovalPlan.DeletionGates) != 10 || releaseCheckPublicFacadeRemovalDeletionGateRemediationActionCount(inventory.RemovalPlan.DeletionGates) != 15 || len(inventory.RemovalPlan.ExecutionSteps) != 5 || releaseCheckPublicFacadeRemovalExecutionFailureSignalCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionRemediationActionCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionVerificationArtifactCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionLedgerEventCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionStateTransitionCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionEscalationTriggerCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionEscalationEvidenceCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionEscalationRecipientCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionEscalationHandoffStepCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionEscalationDecisionOptionCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionEscalationRetryConditionCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionEscalationStopConditionCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionEscalationResolutionArtifactCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionEscalationClosureCheckCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionEscalationReopenConditionCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionEscalationLedgerEventCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionEscalationStateTransitionCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionEscalationBoundaryGuardCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionEscalationAuditCheckCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionBoundaryGuardCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionAuditCheckCount(inventory.RemovalPlan.ExecutionSteps) != 15 || releaseCheckPublicFacadeRemovalExecutionValidationCommandCount(inventory.RemovalPlan.ExecutionSteps) != 40 || len(inventory.RemovalPlan.BoundaryChecks) != 6 || releaseCheckPublicFacadeRemovalBoundaryValidationCommandCount(inventory.RemovalPlan.BoundaryChecks) != 48 || len(inventory.RemovalPlan.RecoverySteps) != 4 || releaseCheckPublicFacadeRemovalRecoveryValidationCommandCount(inventory.RemovalPlan.RecoverySteps) != 32 || len(inventory.RemovalPlan.DocumentationTargets) != 9 || releaseCheckPublicFacadeRemovalDocumentationValidationCommandCount(inventory.RemovalPlan.DocumentationTargets) != 72 || !releaseCheckPublicFacadeRemovalHasReplacementEntrypoint(inventory.RemovalPlan, "canonical-rekit-skill") || !releaseCheckPublicFacadeRemovalHasReplacementEntrypoint(inventory.RemovalPlan, "direct-go-cli") || !releaseCheckPublicFacadeRemovalHasDeletionGate(inventory.RemovalPlan, "go-native-alternatives-ready") || !releaseCheckPublicFacadeRemovalHasDeletionGate(inventory.RemovalPlan, "release-gate-green") || !releaseCheckPublicFacadeRemovalHasExecutionStep(inventory.RemovalPlan, "delete-public-facade") || !releaseCheckPublicFacadeRemovalHasExecutionStep(inventory.RemovalPlan, "rerun-release-gate") || !releaseCheckPublicFacadeRemovalHasBoundaryCheck(inventory.RemovalPlan, "no-powershell-runtime-logic") || !releaseCheckPublicFacadeRemovalHasBoundaryCheck(inventory.RemovalPlan, "no-external-effects") || !releaseCheckPublicFacadeRemovalHasRecoveryStep(inventory.RemovalPlan, "restore-public-facade") || !releaseCheckPublicFacadeRemovalHasDocumentationTarget(inventory.RemovalPlan, "docs/release-readiness.md") || !releaseCheckPublicFacadeRemovalHasDocumentationTarget(inventory.RemovalPlan, "CHANGELOG.md") {
...
func releaseCheckPublicFacadeRemovalReplacementValidationCommandCount(entrypoints []releasecheck.PublicFacadeRemovalReplacementEntrypoint) int {
	count := 0
...
func releaseCheckPublicFacadeRemovalDeletionGateValidationCommandCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
...
func releaseCheckPublicFacadeRemovalDeletionGateExitCriteriaCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateVerificationArtifactCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateFailureSignalCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateEscalationTriggerCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateEscalationEvidenceCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateEscalationRecipientCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateEscalationHandoffStepCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateEscalationDecisionOptionCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateEscalationRetryConditionCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateEscalationStopConditionCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateEscalationResolutionArtifactCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateEscalationClosureCheckCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateEscalationReopenConditionCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateEscalationLedgerEventCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateEscalationStateTransitionCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateEscalationBoundaryGuardCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateEscalationAuditCheckCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateBlockedExecutionStepCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalDeletionGateRemediationActionCount(gates []releasecheck.PublicFacadeRemovalDeletionGate) int {
	count := 0
	for _, gate := range gates {
...
func releaseCheckPublicFacadeRemovalHasDeletionGate(plan releasecheck.PublicFacadeRemovalPlan, name string) bool {
	for _, gate := range plan.DeletionGates {
		if gate.Name == name && gate.Required && gate.BlocksRemoval && strings.TrimSpace(gate.Gate) != "" && len(gate.InputInventory) > 0 && len(gate.BlockedExecutionSteps) == 2 && slices.Contains(gate.BlockedExecutionSteps, "delete-public-facade") && slices.Contains(gate.BlockedExecutionSteps, "rerun-release-gate") && len(gate.ExitCriteria) == 3 && len(gate.FailureSignals) == 3 && len(gate.EscalationTriggers) == 3 && len(gate.EscalationEvidence) == 3 && len(gate.EscalationRecipients) == 3 && len(gate.EscalationHandoffSteps) == 3 && len(gate.EscalationDecisionOptions) == 3 && len(gate.EscalationRetryConditions) == 3 && len(gate.EscalationStopConditions) == 3 && len(gate.EscalationResolutionArtifacts) == 3 && len(gate.EscalationClosureChecks) == 3 && len(gate.EscalationReopenConditions) == 3 && len(gate.EscalationLedgerEvents) == 3 && len(gate.EscalationStateTransitions) == 3 && len(gate.EscalationBoundaryGuards) == 3 && len(gate.EscalationAuditChecks) == 3 && len(gate.VerificationArtifacts) == 3 && len(gate.RemediationActions) == 3 && len(gate.ValidationCommands) == 8 && slices.Contains(gate.ValidationCommands, "go run ./cmd/rekit -- -Command release-check -Format json") {
			return true
		}
	}
	return false
...
func releaseCheckPublicFacadeRemovalHasExecutionStep(plan releasecheck.PublicFacadeRemovalPlan, name string) bool {
	for _, step := range plan.ExecutionSteps {
		if step.Name == name && step.Required && strings.TrimSpace(step.Action) != "" && len(step.DependsOn) > 0 && len(step.InputInventory) > 0 && len(step.OutputArtifacts) > 0 && len(step.FailureSignals) == 3 && len(step.RemediationActions) == 3 && len(step.VerificationArtifacts) == 3 && len(step.LedgerEvents) == 3 && len(step.StateTransitions) == 3 && len(step.EscalationTriggers) == 3 && len(step.EscalationEvidence) == 3 && len(step.EscalationRecipients) == 3 && len(step.EscalationHandoffSteps) == 3 && len(step.EscalationDecisionOptions) == 3 && len(step.EscalationRetryConditions) == 3 && len(step.EscalationStopConditions) == 3 && len(step.EscalationResolutionArtifacts) == 3 && len(step.EscalationClosureChecks) == 3 && len(step.EscalationReopenConditions) == 3 && len(step.EscalationLedgerEvents) == 3 && len(step.EscalationStateTransitions) == 3 && len(step.EscalationBoundaryGuards) == 3 && len(step.EscalationAuditChecks) == 3 && len(step.BoundaryGuards) == 3 && len(step.AuditChecks) == 3 && len(step.ValidationCommands) == 8 && !step.AllowsPowerShellRuntime && !step.AllowsExternalEffects && slices.Contains(step.ValidationCommands, "go run ./cmd/rekit -- -Command release-check -Format json") {
			return true
		}
	}
	return false
...
func releaseCheckPublicFacadeRemovalExecutionFailureSignalCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
...
func releaseCheckPublicFacadeRemovalExecutionRemediationActionCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
...
func releaseCheckPublicFacadeRemovalExecutionVerificationArtifactCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
...
func releaseCheckPublicFacadeRemovalExecutionLedgerEventCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
...
func releaseCheckPublicFacadeRemovalExecutionStateTransitionCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
...
func releaseCheckPublicFacadeRemovalExecutionEscalationTriggerCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
...
func releaseCheckPublicFacadeRemovalExecutionEscalationEvidenceCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
...
func releaseCheckPublicFacadeRemovalExecutionEscalationRecipientCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
...
func releaseCheckPublicFacadeRemovalExecutionEscalationHandoffStepCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
...
func releaseCheckPublicFacadeRemovalExecutionEscalationDecisionOptionCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
...
func releaseCheckPublicFacadeRemovalExecutionEscalationRetryConditionCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
...
func releaseCheckPublicFacadeRemovalExecutionEscalationStopConditionCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
...
func releaseCheckPublicFacadeRemovalExecutionEscalationResolutionArtifactCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
...
func releaseCheckPublicFacadeRemovalExecutionEscalationClosureCheckCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
...
func releaseCheckPublicFacadeRemovalExecutionEscalationReopenConditionCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
		count += len(step.EscalationReopenConditions)
	}
	return count
}

func releaseCheckPublicFacadeRemovalExecutionEscalationLedgerEventCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
		count += len(step.EscalationLedgerEvents)
	}
	return count
}

func releaseCheckPublicFacadeRemovalExecutionEscalationStateTransitionCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
		count += len(step.EscalationStateTransitions)
	}
	return count
}

func releaseCheckPublicFacadeRemovalExecutionEscalationBoundaryGuardCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
		count += len(step.EscalationBoundaryGuards)
	}
	return count
}

func releaseCheckPublicFacadeRemovalExecutionEscalationAuditCheckCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
		count += len(step.EscalationAuditChecks)
	}
	return count
}

func releaseCheckPublicFacadeRemovalExecutionBoundaryGuardCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
...
func releaseCheckPublicFacadeRemovalExecutionAuditCheckCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
...
func releaseCheckPublicFacadeRemovalExecutionValidationCommandCount(steps []releasecheck.PublicFacadeRemovalExecutionStep) int {
	count := 0
	for _, step := range steps {
...
func releaseCheckPublicFacadeRemovalBoundaryValidationCommandCount(checks []releasecheck.PublicFacadeRemovalPlanBoundaryCheck) int {
	count := 0
...
func releaseCheckPublicFacadeRemovalImpactValidationCommandCount(workItems []releasecheck.PublicFacadeRemovalImpactWorkItem) int {
	count := 0
...
func releaseCheckPublicFacadeRemovalSmokeMigrationValidationCommandCount(targets []releasecheck.PublicFacadeRemovalSmokeMigrationTarget) int {
	count := 0
	for _, target := range targets {
		count += len(target.ValidationCommands)
	}
