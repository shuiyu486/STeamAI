...
var requiredPhrases = []requiredPhrase{
	...
	{path: "CLAUDE.md", phrase: "默认远程 CI workflow 是 `.github/workflows/release-gate.yml`，定义 Linux、Windows、macOS Go-native release checks"},
	...
	{path: "docs/agent-team-rollout-plan.md", phrase: "公共 `/rekit` 默认路径已由 20 个 Go-owned/no-fallback public commands 支撑"},
