...
var ciRequiredCommands = []ciRequiredCommand{
	...
	{job: "go-checks-linux", command: "go run ./cmd/skillcontractgen -repo . -check"},
	{job: "go-checks-linux", command: "go vet ./..."},
	{job: "go-checks-linux", command: CanonicalGoPackSmokeCommand},
	...
	{job: "go-checks-windows", command: "go run ./cmd/skillcontractgen -repo . -check"},
	{job: "go-checks-windows", command: "go vet ./..."},
	{job: "go-checks-windows", command: CanonicalGoPackSmokeCommand},
	...
	{job: "go-checks-macos", command: "go run ./cmd/skillcontractgen -repo . -check"},
	{job: "go-checks-macos", command: "go vet ./..."},
	{job: "go-checks-macos", command: CanonicalGoPackSmokeCommand},
