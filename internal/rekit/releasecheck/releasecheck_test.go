...
func assertPublicFacadeRemoval(t *testing.T, inventory PublicFacadeRemoval) {
	...
	if !inventory.RemovalPlan.Ready || inventory.RemovalPlan.Document != "docs/powershell-deprecation.md" || len(inventory.RemovalPlan.RequiredPhrases) != 9 || len(inventory.RemovalPlan.ReplacementEntrypoints) != 4 || publicFacadeRemovalReplacementValidationCommandCount(inventory.RemovalPlan.ReplacementEntrypoints) != 32 || len(inventory.RemovalPlan.DeletionGates) != 5 || publicFacadeRemovalDeletionGateValidationCommandCount(inventory.RemovalPlan.DeletionGates) != 40 || publicFacadeRemovalDeletionGateExitCriteriaCount(inventory.RemovalPlan.DeletionGates) != 15 || publicFacadeRemovalDeletionGateFailureSignalCount(inventory.RemovalPlan.DeletionGates) != 15 || publicFacadeRemovalDeletionGateEscalationTriggerCount(inventory.RemovalPlan.DeletionGates) != 15 || publicFacadeRemovalDeletionGateEscalationEvidenceCount(inventory.RemovalPlan.DeletionGates) != 15 || publicFacadeRemovalDeletionGateEscalationRecipientCount(inventory.RemovalPlan.DeletionGates) != 15 || publicFacadeRemovalDeletionGateEscalationHandoffStepCount(inventory.RemovalPlan.DeletionGates) != 15 || publicFacadeRemovalDeletionGateEscalationDecisionOptionCount(inventory.RemovalPlan.DeletionGates) != 15 || publicFacadeRemovalDeletionGateEscalationRetryConditionCount(inventory.RemovalPlan.DeletionGates) != 15 || publicFacadeRemovalDeletionGateEscalationStopConditionCount(inventory.RemovalPlan.DeletionGates) != 15 || publicFacadeRemovalDeletionGateEscalationResolutionArtifactCount(inventory.RemovalPlan.DeletionGates) != 15 || publicFacadeRemovalDeletionGateEscalationClosureCheckCount(inventory.RemovalPlan.DeletionGates) != 15 || publicFacadeRemovalDeletionGateEscalationReopenConditionCount(inventory.RemovalPlan.DeletionGates) != 15 || publicFacadeRemovalDeletionGateEscalationLedgerEventCount(inventory.RemovalPlan.DeletionGates) != 15 || publicFacadeRemovalDeletionGateEscalationStateTransitionCount(inventory.RemovalPlan.DeletionGates) != 15 || publicFacadeRemovalDeletionGateEscalationBoundaryGuardCount(inventory.RemovalPlan.DeletionGates) != 15 || publicFacadeRemovalDeletionGateEscalationAuditCheckCount(inventory.RemovalPlan.DeletionGates) != 15 || publicFacadeRemovalDeletionGateVerificationArtifactCount(inventory.RemovalPlan.DeletionGates) != 15 || publicFacadeRemovalDeletionGateBlockedExecutionStepCount(inventory.RemovalPlan.DeletionGates) != 10 || publicFacadeRemovalDeletionGateRemediationActionCount(inventory.RemovalPlan.DeletionGates) != 15 || len(inventory.RemovalPlan.ExecutionSteps) != 5 || publicFacadeRemovalExecutionFailureSignalCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionRemediationActionCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionVerificationArtifactCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionLedgerEventCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionStateTransitionCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionEscalationTriggerCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionEscalationEvidenceCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionEscalationRecipientCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionEscalationHandoffStepCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionEscalationDecisionOptionCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionEscalationRetryConditionCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionEscalationStopConditionCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionEscalationResolutionArtifactCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionEscalationClosureCheckCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionEscalationReopenConditionCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionEscalationLedgerEventCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionEscalationStateTransitionCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionEscalationBoundaryGuardCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionEscalationAuditCheckCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionBoundaryGuardCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionAuditCheckCount(inventory.RemovalPlan.ExecutionSteps) != 15 || publicFacadeRemovalExecutionValidationCommandCount(inventory.RemovalPlan.ExecutionSteps) != 40 || len(inventory.RemovalPlan.BoundaryChecks) != 6 || publicFacadeRemovalBoundaryValidationCommandCount(inventory.RemovalPlan.BoundaryChecks) != 48 || len(inventory.RemovalPlan.RecoverySteps) != 4 || publicFacadeRemovalRecoveryValidationCommandCount(inventory.RemovalPlan.RecoverySteps) != 32 || len(inventory.RemovalPlan.DocumentationTargets) != 9 || publicFacadeRemovalDocumentationValidationCommandCount(inventory.RemovalPlan.DocumentationTargets) != 72 || !publicFacadeRemovalHasReplacementEntrypoint(inventory.RemovalPlan, "canonical-rekit-skill") || !publicFacadeRemovalHasReplacementEntrypoint(inventory.RemovalPlan, "direct-go-cli") || !publicFacadeRemovalHasDeletionGate(inventory.RemovalPlan, "go-native-alternatives-ready") || !publicFacadeRemovalHasDeletionGate(inventory.RemovalPlan, "release-gate-green") || !publicFacadeRemovalHasExecutionStep(inventory.RemovalPlan, "delete-public-facade") || !publicFacadeRemovalHasExecutionStep(inventory.RemovalPlan, "rerun-release-gate") || !publicFacadeRemovalHasBoundaryCheck(inventory.RemovalPlan, "no-powershell-runtime-logic") || !publicFacadeRemovalHasBoundaryCheck(inventory.RemovalPlan, "no-external-effects") || !publicFacadeRemovalHasRecoveryStep(inventory.RemovalPlan, "restore-public-facade") || !publicFacadeRemovalHasDocumentationTarget(inventory.RemovalPlan, "docs/release-readiness.md") || !publicFacadeRemovalHasDocumentationTarget(inventory.RemovalPlan, "CHANGELOG.md") {
