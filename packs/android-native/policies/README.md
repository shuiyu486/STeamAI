# Android native / JNI security research policy overlay

本 pack 继承 case `.steamai-vnext/CLAUDE.md` 与 case-local contracts。领域补充如下：

- 研究重点：APK native library triage、JNI 边界、hook candidate 与 emulator 侧证据。
- app_ref、library_ref、jni_symbol_ref、component_ref 只能作为 case-local 脱敏引用。
