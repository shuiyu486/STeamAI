# Android native / JNI security research workflow
...
领域重点：APK native library triage、JNI 边界、hook candidate 与 emulator 侧证据。任何新证据超出原授权或暴露新的外部副作用时立即停止并升级给 Commander。
