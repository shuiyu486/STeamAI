# CTF and lab challenge research workflow
...
领域重点：challenge triage、solver hypothesis、local reproduction 与 writeup review。任何新证据超出原授权或暴露新的外部副作用时立即停止并升级给 Commander。
