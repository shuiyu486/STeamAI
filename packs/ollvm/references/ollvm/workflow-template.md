# OLLVM and native obfuscation research workflow
...
领域重点：control-flow flattening、opaque predicate、MBA simplification 与 CFG 证据。任何新证据超出原授权或暴露新的外部副作用时立即停止并升级给 Commander。
