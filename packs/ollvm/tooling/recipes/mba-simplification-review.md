# Mba Simplification Review

## 适用范围

用于 control-flow flattening、opaque predicate、MBA simplification 与 CFG 证据 中的窄范围 `mba-simplification-review` 任务。只处理 case-local 脱敏引用和已存在的有界输入。
