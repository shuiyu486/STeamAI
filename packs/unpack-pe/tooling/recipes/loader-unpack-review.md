# Loader Unpack Review

## 适用范围

用于 PE static triage、loader behavior、unpack candidate 与 import recovery evidence 中的窄范围 `loader-unpack-review` 任务。只处理 case-local 脱敏引用和已存在的有界输入。
