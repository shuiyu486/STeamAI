...
| 查看 VMP policy overlay | `../../policies/README.md` | VMP handler 分片、captures 预算、经验回流和 routine IR 验证 overlay。 |
...
3. 若发现可复用方法/坑点，先按 `../../policies/review-first.overlay.md` 分类：common policy、pack overlay、reference doc、tooling recipe 或 case-only。
