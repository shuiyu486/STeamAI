# Authorized vulnerability research workflow
...
领域重点：crash triage、root-cause hypothesis、repro evidence 与 patch analysis。任何新证据超出原授权或暴露新的外部副作用时立即停止并升级给 Commander。
