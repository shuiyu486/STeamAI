...
本 pack 用于授权 Web/API 安全评估、靶场/CTF 或防御性安全工程场景的 Agent Team 工作流。它是非 RE pack 的首个最小骨架，当前重点是 route、ledger、handoff、tooling adapter 和 review-first 契约，不是自动化扫描或攻击平台。
