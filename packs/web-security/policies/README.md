# Authorized Web and API security research policy overlay

本 pack 继承 case `.steamai-vnext/CLAUDE.md` 与 case-local contracts。领域补充如下：

- 研究重点：passive triage、request hypothesis、bounded replay 与 remediation evidence。
- target_ref、endpoint_ref、request_ref、finding_ref 只能作为 case-local 脱敏引用。
